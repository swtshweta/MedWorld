	...
	$.fn.extend({
		smoothSlideshow: function (wrapper, options) {
			...
			_T.slideshow = function (options) {
				...
				this.options.navOpacity = 100;
				this.options.thumbScrollSpeed = 5000;
				this.options.letterbox = '#000';
				this.options.slideInfoZoneOpacity = 1;
			...
			_T.slideshow.prototype = {
				init: function (s, options) {
					...
					for (i; i < this.l; i++) {
						...
						if (this.options.showCarousel) {
							...
							(function (t) {
								...
								$('#dfcg-slider').append('<p id="this-'+i+'">'+t+'</p>');
					...
					if (this.options.showCarousel) {
						$(this.options.thumbnailContainerSelector).mouseover(function (e) {}).mouseout(function () { (new Function('_T.scroll.cl("' + _this.options.thumbnailContainerSelector + '")'))()
						})
					} else {
